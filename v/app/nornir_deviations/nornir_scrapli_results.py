...
from data.writer import write_legacy_format
...
class ScrapliResult(Result):  # type: ignore
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            host=host, result=result, failed=failed, changed=changed, **kwargs
        )
    ...
    @staticmethod
    def _process_failed(
        scrapli_response: Optional[Union[Response, MultiResponse]]
    ) -> bool:
        """
        Process and return string of scrapli response(s)
        Args:
